...
export default function Footer() {
  ...
  const whatsappNumber = "2694460291"; // 002694460291 sans les zéros initiaux
  const whatsappLink =
      ...
      <div className="mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-1">
            <h4 className="font-semibold text-foreground-inverse">Product</h4>
          ...
          <div className="col-span-1">
            <h4 className="font-semibold text-foreground-inverse">Company</h4>
            ...
            <div className="mt-3 grid space-y-3">
              ...
              <p>
                ...
                <span className="inline-block ms-1 text-xs bg-primary text-primary-foreground py-1 px-2 rounded-lg">
                  We&apos;re hiring
                </span>
              </p>
              <p>
              ...
              <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-layer rounded-lg p-2">
                <div className="w-full">
                  ...
                  <input
                    ...
                    id="hero-input"
                    name="hero-input"
                    className="py-2.5 sm:py-3 px-4 block w-full bg-transparent border-transparent rounded-lg sm:text-sm text-foreground placeholder:text-muted-foreground-1 focus:border-primary-focus focus:ring-primary-focus disabled:opacity-50 disabled:pointer-events-none"
